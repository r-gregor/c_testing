...
void printDateDiff(int, int, int);

/** main */
int main(int argc, char **argv) {
	printDateDiff(2022,1,7);
	printDateDiff(2022,4,7);
	printDateDiff(1968,2,22);
	printDateDiff(2022,2,22);
	printDateDiff(2023,1,1);

	return 0;
} /* end main */

void printDateDiff(int _year, int _month, int _day) {
