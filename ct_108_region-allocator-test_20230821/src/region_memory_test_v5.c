 ...
 * TODO: if fsize > REGION_CAPACITY, allocate bigger region
 */
...
// unsigned char data[REGION_CAPACITY];

/**
 * main
 */
int main(int argc, char **argv) {
	static unsigned char data[REGION_CAPACITY];
