...
// operations functions initializations for 4D vectors
Vec4f vec4f_sum(Vec4f,Vec4f);
Vec4f vec4f_sub(Vec4f,Vec4f);
Vec4f vec4f_mul(Vec4f,Vec4f);
Vec4f vec4f_div(Vec4f,Vec4f);
Vec4f vec4f_max(Vec4f,Vec4f);
Vec4f vec4f_min(Vec4f,Vec4f);
float vec4f_sqrlen(Vec4f);
Vec4f vec4f_lerp(Vec4f,Vec4f,Vec4f);
Vec4f vec4f_sqrt(Vec4f);
Vec4f vec4f_pow(Vec4f,Vec4f);
