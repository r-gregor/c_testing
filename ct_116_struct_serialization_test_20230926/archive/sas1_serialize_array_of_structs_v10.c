/*
 * sas1_serialize_array_of_structs_v10.c
 * v10: include "fpath_to_abspath_v1.h" --> serialize to file relative
...
#include "serialize_v2.h"         // v9
#include "fpath_to_abspath_v1.h"  // v10
