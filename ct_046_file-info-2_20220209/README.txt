***
V1 works on large files because it does NOT load file into memmory.
...
***
V2 does NOT work on large files, because it tries to load file contents into
...
***
V3 does NOT work on large files because the segmentation fault happens before the test!


***
V3 WORKS!! (file content malloc into heap memory 20220209)
gregor.redelonghi@cygwin-en ~/C_and_Cpp_en_testing/c_en_testing/test_files/large
$> for FFF in *; do ../../cn019_file-info_20211117/bin/file-info_V4.exe $FFF; done
Filename: bible.txt
Size:     4047392 bytes
Lines:    30383
---
