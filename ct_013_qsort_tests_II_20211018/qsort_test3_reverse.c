...
/*
 * accending: Movie1 - Movie2
 * decending: Movie2 - Movie1 (REVERSE)
 */
int comparator_reverse(const void* a, const void* b) {
    Movie *movie1 = (Movie *)a;
    Movie *movie2 = (Movie *)b;
    return (movie2->date - movie1->date);
}
...
int main() {
    ...
    array[3].date = 20001231;
    array[3].fname = "a-filename-with-number_20001231.txt";
    array[4].date = 19951231;
    array[4].fname = "a-filename-with-number_19951231.txt";
    array[5].date = 20220222;
    array[5].fname = "a-filename-with-number_2022022.txt";
    ...
    qsort(array, N, sizeof(Movie), comparator_reverse);
