/*
 * vector_test_v2.c
 * from: c_howto_implement-vector_20240819.txt
 *       https://aticleworld.com/implement-vector-in-c/
 * ---
 * 20240819_01_mdb: v1 (ORIGINAL)
 * 20240819_02_MDB: V2
 */
...
int main(int argc, char *argv[]) {
	...
	VECTOR_INIT(v);
	//Add data in vector
	v.pfVectorAdd(&v,"GREGOR REDELONGHI\n");
	v.pfVectorAdd(&v,"TADEJA MALI REDELONGHI\n");
	v.pfVectorAdd(&v,"ZALA REDELONGHI\n");
	...
	v.pfVectorSet(&v,0,"SISI TAMALA REDELONGHI\n");

	printf("--- Vector list after changes ---\n\n"); //v2
